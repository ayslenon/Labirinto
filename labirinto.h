...
public:
  ...
  ///
  /// O parametro NAbert retorna o numero de nos em aberto ao termino do algoritmo A*
  /// O parametro NFech retorna o numero de nos em fechado ao termino do algoritmo A*
  /// Mesmo quando nao existe caminho, esses parametros devem ser retornados
  double calculaCaminho(int& prof, int& NAbert, int& NFech);
};
